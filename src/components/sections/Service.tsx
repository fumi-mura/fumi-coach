const recommendedItems = [
  "自分のやりたいことが見つからない、迷っている",
  "転職・キャリアチェンジを考えているが一歩踏み出せない",
  "目標はあるけど行動できない自分がいる",
  "誰かに話を聞いてもらいながら思考を整理したい",
  "自分の強みや価値観を深く理解したい",
];
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20 md:pb-28">
        ...
        <div className="space-y-5 font-sans text-ink-muted text-base leading-relaxed">
          <p>
            ...
            アドバイスや指示をするのではなく、問いかけと傾聴によって、あなた自身が気づき、選択し、行動できるようサポートします。
          </p>
          <p>
