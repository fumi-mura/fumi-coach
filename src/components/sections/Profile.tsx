        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-5 font-sans text-ink-muted text-base leading-relaxed">
              <p>
                （ここにストーリーを入力してください）社会人になってからずっと、「正解」を探し続けていました。
                周りの期待に応えようとするうちに、自分が本当に望むことが分からなくなっていた時期があります。
              </p>
              <p>
                そんなとき、コーチングと出会いました。コーチとの対話の中で、自分の価値観や強みに気づき、
                少しずつ「自分の人生」を歩めるようになっていきました。
              </p>
              <p>
                この体験を多くの人に届けたいという思いから、コーチとしての活動を始めました。
                あなたの「なりたい自分」を一緒に見つけていきましょう。
              </p>
            </div>
